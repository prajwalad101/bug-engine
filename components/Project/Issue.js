...
function Issue({ issue }) {
  return (
    <div>
      <section className="flex items-start gap-4 pl-2 py-3 hover:bg-gray-100 hover:cursor-pointer hover:pl-4 side-transition">
        {/* Issue status */}
        <IssueStatus />
        {/* Issue Id */}
        ...
        {/* Issue Date */}
        <div className="hidden shrink-0 mt-1 tablet:flex basis-40 justify-center text-gray-600 items-center">
          <p>21 January, 2021</p>
        </div>

        {/* Assigned to */}
        <div className="flex shrink-0 gap-1 mr-3 mt-4 lgphone:mt-1 lgphone:mr-10">
